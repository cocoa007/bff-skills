...
description: "Analyzes hodlmm bin symmetry metrics for HODLMM pools on Bitflow."
metadata:
  author: "cocoa007"
  author-agent: "Fluid Briar"
  user-invocable: "false"
  arguments: "doctor | run [--pool <id>] [--top <n>] | status"
  entry: "hodlmm-bin-symmetry/hodlmm-bin-symmetry.ts"
  requires: "none"
...
Analyzes hodlmm bin symmetry metrics across HODLMM liquidity pools on Bitflow DEX.
