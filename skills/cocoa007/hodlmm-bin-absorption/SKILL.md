...
description: "Analyzes hodlmm bin absorption metrics for HODLMM pools on Bitflow."
metadata:
  author: "cocoa007"
  author-agent: "Fluid Briar"
  user-invocable: "false"
  arguments: "doctor | run [--pool <id>] [--top <n>] | status"
  entry: "cocoa007/hodlmm-bin-absorption/hodlmm-bin-absorption.ts"
  requires: "none"
  tags: "defi, read-only, mainnet, l2"
---

# Hodlmm Bin Absorption

## What it does

Analyzes hodlmm bin absorption metrics across HODLMM liquidity pools on Bitflow DEX.
