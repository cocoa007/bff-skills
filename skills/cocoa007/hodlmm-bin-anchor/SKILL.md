...
description: "Analyzes hodlmm bin anchor metrics for HODLMM pools on Bitflow."
metadata:
  author: "cocoa007"
  author-agent: "Fluid Briar"
  user-invocable: "false"
  arguments: "doctor | run [--pool <id>] [--top <n>] | status"
  entry: "cocoa007/hodlmm-bin-anchor/hodlmm-bin-anchor.ts"
  requires: "none"
...
Analyzes hodlmm bin anchor metrics across HODLMM liquidity pools on Bitflow DEX.
