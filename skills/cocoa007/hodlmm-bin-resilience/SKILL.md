...
description: "Analyzes hodlmm bin resilience metrics for HODLMM pools on Bitflow."
metadata:
  author: "cocoa007"
  author-agent: "Fluid Briar"
  user-invocable: "false"
  arguments: "doctor | run [--pool <id>] [--top <n>] | status"
  entry: "cocoa007/hodlmm-bin-resilience/hodlmm-bin-resilience.ts"
  requires: "none"
  tags: "defi, read-only, mainnet, l2"
---

# Hodlmm Bin Resilience

## What it does

Analyzes hodlmm bin resilience metrics across HODLMM liquidity pools on Bitflow DEX.
